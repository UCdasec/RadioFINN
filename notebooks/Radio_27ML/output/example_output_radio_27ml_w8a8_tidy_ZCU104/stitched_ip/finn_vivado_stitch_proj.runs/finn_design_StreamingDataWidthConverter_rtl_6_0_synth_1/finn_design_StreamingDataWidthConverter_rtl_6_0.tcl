...
synth_design -top finn_design_StreamingDataWidthConverter_rtl_6_0 -part xczu7ev-ffvc1156-2-e -incremental_mode off -mode out_of_context
...
generate_parallel_reports -reports { "report_utilization -file finn_design_StreamingDataWidthConverter_rtl_6_0_utilization_synth.rpt -pb finn_design_StreamingDataWidthConverter_rtl_6_0_utilization_synth.pb"  } 
