...
synth_design -top finn_design_wrapper -part xczu7ev-ffvc1156-2-e
...
generate_parallel_reports -reports { "report_utilization -file finn_design_wrapper_utilization_synth.rpt -pb finn_design_wrapper_utilization_synth.pb"  } 
