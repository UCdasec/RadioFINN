...
--               /home/phu/repos/PytorchModClassNew/RadioFINN/notebooks/Radio_27ML/output/example_output_radio_27ml_w8a8_tidy_ZCU104/stitched_ip/finn_vivado_stitch_proj.gen/sources_1/bd/finn_design/ip/finn_design_FMPadding_rtl_2_0/finn_design_FMPadding_rtl_2_0_sim_netlist.vhdl
...
architecture STRUCTURE of finn_design_FMPadding_rtl_2_0_axi2we is
  ...
  attribute SOFT_HLUTNM of \YEnd[8]_i_2\ : label is "soft_lutpair2";
...
\YEnd[8]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"10"
    )
        port map (
...
architecture STRUCTURE of finn_design_FMPadding_rtl_2_0_fmpadding is
  ...
  signal \YCount[8]_i_10_n_0\ : STD_LOGIC;
  signal \YCount[8]_i_1_n_0\ : STD_LOGIC;
  signal \YCount[8]_i_5_n_0\ : STD_LOGIC;
  signal \YCount[8]_i_6_n_0\ : STD_LOGIC;
  signal \YCount[8]_i_7_n_0\ : STD_LOGIC;
  signal \YCount[8]_i_8_n_0\ : STD_LOGIC;
  signal \YCount[8]_i_9_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \YCount[7]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \YCount[8]_i_12\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \YCount[8]_i_13\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \YCount[8]_i_3\ : label is "soft_lutpair5";
...
\YCount[8]_i_10\: unisim.vcomponents.LUT6
    generic map(
...
\YCount[8]_i_11\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
\YCount[8]_i_12\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\YCount[8]_i_13\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
\YCount[8]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\YCount[8]_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
\YCount[8]_i_5\: unisim.vcomponents.LUT6
    generic map(
...
\YCount[8]_i_6\: unisim.vcomponents.LUT6
    generic map(
...
\YCount[8]_i_7\: unisim.vcomponents.LUT6
    generic map(
...
\YCount[8]_i_8\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
...
\YCount[8]_i_9\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
...
yfwd0_carry_i_6: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
entity finn_design_FMPadding_rtl_2_0 is
  ...
  attribute X_CORE_INFO of finn_design_FMPadding_rtl_2_0 : entity is "FMPadding_rtl_2,Vivado 2024.1";
