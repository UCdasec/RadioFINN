...
module StreamingMaxPool_hls_6_StreamingMaxPool_hls_6_Pipeline_VITIS_LOOP_269_4_VITIS_LOOP_271_5 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [0:0] icmp_ln269_reg_159;
wire   [0:0] icmp_ln269_reg_159_pp0_iter0_reg;
reg   [0:0] icmp_ln269_reg_159_pp0_iter1_reg;
reg   [7:0] inputData_reg_163;
reg   [7:0] inputData_reg_163_pp0_iter1_reg;
reg   [5:0] buf_addr_reg_169;
wire   [63:0] zext_ln271_fu_124_p1;
reg   [6:0] ch_fu_46;
wire   [6:0] add_ln271_fu_129_p2;
wire    ap_loop_init;
...
reg    buf_r_ce1_local;
reg    buf_r_we0_local;
wire   [0:0] icmp_ln280_fu_140_p2;
reg    buf_r_ce0_local;
wire   [0:0] icmp_ln271_fu_110_p2;
wire   [6:0] select_ln266_fu_116_p3;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_iter0_fsm_state1) & (ap_loop_init == 1'b1))) begin
        ch_fu_46 <= 7'd0;
    end else if (((icmp_ln269_reg_159_pp0_iter0_reg == 1'd0) & (1'b1 == ap_CS_iter1_fsm_state2))) begin
        ch_fu_46 <= add_ln271_fu_129_p2;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_iter0_fsm_state1))) begin
        ...
        icmp_ln269_reg_159 <= icmp_ln269_fu_90_p2;
        inputData_reg_163 <= in0_V_TDATA;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_iter1_fsm_state2)) begin
        buf_addr_reg_169 <= zext_ln271_fu_124_p1;
        icmp_ln269_reg_159_pp0_iter1_reg <= icmp_ln269_reg_159;
        inputData_reg_163_pp0_iter1_reg <= inputData_reg_163;
    end
end
...
always @ (*) begin
    if (((icmp_ln269_reg_159_pp0_iter1_reg == 1'd0) & (1'b1 == ap_CS_iter2_fsm_state3) & (icmp_ln280_fu_140_p2 == 1'd1))) begin
...
always @ (*) begin
    case (ap_CS_iter2_fsm)
        ap_ST_iter2_fsm_state3 : begin
            ...
            end else if (((1'b1 == ap_CS_iter1_fsm_state2) | ((icmp_ln269_reg_159_pp0_iter1_reg == 1'd1) & (1'b1 == ap_CS_iter2_fsm_state3)))) begin
...
assign add_ln271_fu_129_p2 = (select_ln266_fu_116_p3 + 7'd1);
...
assign buf_r_address0 = buf_addr_reg_169;

assign buf_r_address1 = zext_ln271_fu_124_p1;

assign buf_r_ce0 = buf_r_ce0_local;

assign buf_r_ce1 = buf_r_ce1_local;

assign buf_r_d0 = inputData_reg_163_pp0_iter1_reg;

assign buf_r_we0 = buf_r_we0_local;

assign icmp_ln269_fu_90_p2 = ((ap_sig_allocacmp_indvar_flatten_load == 8'd128) ? 1'b1 : 1'b0);

assign icmp_ln269_reg_159_pp0_iter0_reg = icmp_ln269_reg_159;

assign icmp_ln271_fu_110_p2 = ((ch_fu_46 == 7'd64) ? 1'b1 : 1'b0);

assign icmp_ln280_fu_140_p2 = ((inputData_reg_163_pp0_iter1_reg > buf_r_q1) ? 1'b1 : 1'b0);

assign select_ln266_fu_116_p3 = ((icmp_ln271_fu_110_p2[0:0] == 1'b1) ? 7'd0 : ch_fu_46);

assign zext_ln271_fu_124_p1 = select_ln266_fu_116_p3;

endmodule //StreamingMaxPool_hls_6_StreamingMaxPool_hls_6_Pipeline_VITIS_LOOP_269_4_VITIS_LOOP_271_5
