...
-- Date        : Wed Dec 11 09:57:05 2024
-- Host        : Titan-I7 running 64-bit Ubuntu 22.04.5 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/phu/repos/PytorchModClassNew/RadioFINN/notebooks/Radio_27ML/output/example_output_radio_27ml_w8a8_tidy_ZCU104/stitched_ip/finn_vivado_stitch_proj.gen/sources_1/bd/finn_design/ip/finn_design_FMPadding_rtl_6_0/finn_design_FMPadding_rtl_6_0_sim_netlist.vhdl
...
architecture STRUCTURE of finn_design_FMPadding_rtl_6_0_axi2we is
  ...
  attribute SOFT_HLUTNM of \YEnd[4]_i_2\ : label is "soft_lutpair2";
...
\YEnd[4]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"10"
    )
        port map (
...
architecture STRUCTURE of finn_design_FMPadding_rtl_6_0_fmpadding is
  ...
  signal \YCount[4]_i_10_n_0\ : STD_LOGIC;
  signal \YCount[4]_i_12_n_0\ : STD_LOGIC;
  signal \YCount[4]_i_14_n_0\ : STD_LOGIC;
  signal \YCount[4]_i_1_n_0\ : STD_LOGIC;
  signal \YCount[4]_i_5_n_0\ : STD_LOGIC;
  signal \YCount[4]_i_6_n_0\ : STD_LOGIC;
  signal \YCount[4]_i_8_n_0\ : STD_LOGIC;
  ...
  signal \yen0__0\ : STD_LOGIC;
  signal yfwd09_in : STD_LOGIC;
  signal \yfwd0__20\ : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  ...
  attribute SOFT_HLUTNM of \XCount[0]_i_1\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \YCount[4]_i_13\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \YCount[4]_i_3\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \YCount[4]_i_7\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \YCount[4]_i_9\ : label is "soft_lutpair5";
begin
...
\XCount[0]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"5555555100000000"
    )
        port map (
      I0 => \YCount[4]_i_8_n_0\,
      I1 => \^e\(0),
      I2 => in0_V_TVALID,
      I3 => \YCount[4]_i_6_n_0\,
      I4 => \YCount[4]_i_5_n_0\,
      I5 => SCount,
      O => xen
    );
...
\YCount[4]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"8F"
    )
        port map (
...
\YCount[4]_i_10\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => YEnd(1),
      I5 => YCount_reg(1),
      O => \YCount[4]_i_10_n_0\
    );
\YCount[4]_i_11\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
\YCount[4]_i_12\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => YOn(2),
      I5 => YCount_reg(2),
      O => \YCount[4]_i_12_n_0\
    );
\YCount[4]_i_13\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\YCount[4]_i_14\: unisim.vcomponents.LUT6
    generic map(
...
\YCount[4]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000AAA800000000"
        ...
        port map (
      I0 => SCount,
      I1 => \YCount[4]_i_5_n_0\,
      I2 => \YCount[4]_i_6_n_0\,
      I3 => sen13_out,
      I4 => \YCount[4]_i_8_n_0\,
      I5 => \yen0__0\,
      O => yen
    );
...
\YCount[4]_i_6\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => YOff(3),
      I4 => YCount_reg(3),
      I5 => \YCount[4]_i_14_n_0\,
      O => \YCount[4]_i_6_n_0\
    );
\YCount[4]_i_7\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
\YCount[4]_i_8\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\YCount[4]_i_9\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
architecture STRUCTURE of finn_design_FMPadding_rtl_6_0_fmpadding_axi is
  ...
  signal axilight_adapter_n_14 : STD_LOGIC;
...
axilight_adapter: entity work.finn_design_FMPadding_rtl_6_0_axi2we
     port map (
      ...
      \Data_reg[0]_1\ => axilight_adapter_n_14,
      \Data_reg[0]_2\ => axilight_adapter_n_15,
      E(0) => WABusy_reg_inv,
...
padding: entity work.finn_design_FMPadding_rtl_6_0_fmpadding
     port map (
      ...
      \XOff_reg[0]_1\ => axilight_adapter_n_14,
      \XOn_reg[0]_0\ => padding_n_2,
      \XOn_reg[0]_1\ => axilight_adapter_n_15,
...
entity finn_design_FMPadding_rtl_6_0 is
  ...
  attribute X_CORE_INFO of finn_design_FMPadding_rtl_6_0 : entity is "FMPadding_rtl_6,Vivado 2024.1";
