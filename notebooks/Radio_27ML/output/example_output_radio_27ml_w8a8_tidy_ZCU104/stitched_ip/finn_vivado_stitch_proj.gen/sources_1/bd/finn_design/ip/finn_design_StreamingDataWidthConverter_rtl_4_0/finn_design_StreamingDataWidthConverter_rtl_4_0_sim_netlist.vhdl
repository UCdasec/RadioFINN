...
--               /home/phu/repos/PytorchModClassNew/RadioFINN/notebooks/Radio_27ML/output/example_output_radio_27ml_w8a8_tidy_ZCU104/stitched_ip/finn_vivado_stitch_proj.gen/sources_1/bd/finn_design/ip/finn_design_StreamingDataWidthConverter_rtl_4_0/finn_design_StreamingDataWidthConverter_rtl_4_0_sim_netlist.vhdl
...
architecture STRUCTURE of finn_design_StreamingDataWidthConverter_rtl_4_0_dwc is
  ...
  signal \genUp.ADat[1][15]_i_1_n_0\ : STD_LOGIC;
  signal \genUp.BDat\ : STD_LOGIC_VECTOR ( 15 downto 0 );
  ...
  signal \^out_v_tdata\ : STD_LOGIC_VECTOR ( 31 downto 0 );
  signal \^out_v_tvalid\ : STD_LOGIC;
  signal \^s_axis_tready\ : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \genUp.ACnt[0]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \genUp.ADat[1][0]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \genUp.ADat[1][10]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \genUp.ADat[1][11]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \genUp.ADat[1][12]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \genUp.ADat[1][13]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \genUp.ADat[1][14]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \genUp.ADat[1][15]_i_2\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \genUp.ADat[1][1]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \genUp.ADat[1][2]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \genUp.ADat[1][3]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \genUp.ADat[1][4]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \genUp.ADat[1][5]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \genUp.ADat[1][6]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \genUp.ADat[1][7]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \genUp.ADat[1][8]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \genUp.ADat[1][9]_i_1\ : label is "soft_lutpair5";
...
\genUp.ADat[1][15]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"D0DD"
    )
        port map (
...
\genUp.ADat[1][15]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"AC"
    )
        port map (
...
entity finn_design_StreamingDataWidthConverter_rtl_4_0 is
  ...
  attribute X_CORE_INFO of finn_design_StreamingDataWidthConverter_rtl_4_0 : entity is "StreamingDataWidthConverter_rtl_4,Vivado 2024.1";
