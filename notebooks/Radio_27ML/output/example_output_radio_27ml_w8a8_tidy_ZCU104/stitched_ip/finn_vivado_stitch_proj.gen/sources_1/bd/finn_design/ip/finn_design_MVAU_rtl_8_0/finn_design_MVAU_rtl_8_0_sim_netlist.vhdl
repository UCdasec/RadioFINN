...
-- Date        : Wed Dec 11 09:57:46 2024
-- Host        : Titan-I7 running 64-bit Ubuntu 22.04.5 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/phu/repos/PytorchModClassNew/RadioFINN/notebooks/Radio_27ML/output/example_output_radio_27ml_w8a8_tidy_ZCU104/stitched_ip/finn_vivado_stitch_proj.gen/sources_1/bd/finn_design/ip/finn_design_MVAU_rtl_8_0/finn_design_MVAU_rtl_8_0_sim_netlist.vhdl
-- Design      : finn_design_MVAU_rtl_8_0
...
entity finn_design_MVAU_rtl_8_0_mvu_8sx8u_dsp48 is
  port (
  ...
  attribute ORIG_REF_NAME of finn_design_MVAU_rtl_8_0_mvu_8sx8u_dsp48 : entity is "mvu_8sx8u_dsp48";
end finn_design_MVAU_rtl_8_0_mvu_8sx8u_dsp48;

architecture STRUCTURE of finn_design_MVAU_rtl_8_0_mvu_8sx8u_dsp48 is
  ...
  signal \genPipes[0].genblk3[1].blkLo.Lo4\ : STD_LOGIC_VECTOR ( 20 downto 0 );
  ...
  attribute SOFT_HLUTNM of \A[rdy]_i_1\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \B[dat][0][10]_i_1\ : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of \B[dat][0][11]_i_1\ : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of \B[dat][0][12]_i_1\ : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of \B[dat][0][13]_i_1\ : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of \B[dat][0][14]_i_1\ : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of \B[dat][0][15]_i_1\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \B[dat][0][16]_i_1\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \B[dat][0][17]_i_1\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \B[dat][0][18]_i_1\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \B[dat][0][19]_i_1\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \B[dat][0][1]_i_1\ : label is "soft_lutpair33";
  attribute SOFT_HLUTNM of \B[dat][0][20]_i_2\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \B[dat][0][2]_i_1\ : label is "soft_lutpair33";
  attribute SOFT_HLUTNM of \B[dat][0][3]_i_1\ : label is "soft_lutpair32";
  attribute SOFT_HLUTNM of \B[dat][0][4]_i_1\ : label is "soft_lutpair32";
  attribute SOFT_HLUTNM of \B[dat][0][5]_i_1\ : label is "soft_lutpair31";
  attribute SOFT_HLUTNM of \B[dat][0][6]_i_1\ : label is "soft_lutpair31";
  attribute SOFT_HLUTNM of \B[dat][0][7]_i_1\ : label is "soft_lutpair30";
  attribute SOFT_HLUTNM of \B[dat][0][8]_i_1\ : label is "soft_lutpair30";
  attribute SOFT_HLUTNM of \B[dat][0][9]_i_1\ : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of \B[vld]_i_2\ : label is "soft_lutpair23";
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity finn_design_MVAU_rtl_8_0_replay_buffer is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of finn_design_MVAU_rtl_8_0_replay_buffer : entity is "replay_buffer";
end finn_design_MVAU_rtl_8_0_replay_buffer;

architecture STRUCTURE of finn_design_MVAU_rtl_8_0_replay_buffer is
  signal \Count[6]_i_2_n_0\ : STD_LOGIC;
  signal Count_reg : STD_LOGIC_VECTOR ( 6 downto 1 );
  signal \Count_reg_n_0_[0]\ : STD_LOGIC;
  signal \FP[7]_i_2_n_0\ : STD_LOGIC;
  signal FP_reg : STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  signal RP0 : STD_LOGIC_VECTOR ( 7 to 7 );
  signal RP0_0 : STD_LOGIC_VECTOR ( 6 downto 0 );
  signal \RP[7]_i_2_n_0\ : STD_LOGIC;
  signal RP_reg : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal \WP[7]_i_3_n_0\ : STD_LOGIC;
  ...
  signal \WP_reg_n_0_[7]\ : STD_LOGIC;
  ...
  signal \blkRep.RepLst_i_3_n_0\ : STD_LOGIC;
  ...
  signal in0_V_TREADY_INST_0_i_4_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \FP[2]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \FP[3]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \FP[5]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \FP[6]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of Last_i_4 : label is "soft_lutpair3";
  attribute METHODOLOGY_DRC_VIOS : string;
  attribute METHODOLOGY_DRC_VIOS of Mem_reg_0_63_0_6 : label is "";
  attribute RTL_RAM_BITS : integer;
  attribute RTL_RAM_BITS of Mem_reg_0_63_0_6 : label is 1024;
  ...
  attribute METHODOLOGY_DRC_VIOS of Mem_reg_0_63_7_7 : label is "";
  attribute RTL_RAM_BITS of Mem_reg_0_63_7_7 : label is 1024;
  attribute RTL_RAM_NAME of Mem_reg_0_63_7_7 : label is "inst/inst/activation_replay/Mem_reg_0_63_7_7";
  ...
  attribute RTL_RAM_BITS of Mem_reg_64_127_0_6 : label is 1024;
  attribute RTL_RAM_NAME of Mem_reg_64_127_0_6 : label is "inst/inst/activation_replay/Mem_reg_64_127_0_6";
  ...
  attribute METHODOLOGY_DRC_VIOS of Mem_reg_64_127_7_7 : label is "";
  attribute RTL_RAM_BITS of Mem_reg_64_127_7_7 : label is 1024;
  attribute RTL_RAM_NAME of Mem_reg_64_127_7_7 : label is "inst/inst/activation_replay/Mem_reg_64_127_7_7";
  ...
  attribute SOFT_HLUTNM of \ODat[0]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \ODat[1]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \ODat[2]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \ODat[3]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \ODat[4]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \ODat[5]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \ODat[6]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \ODat[7]_i_2\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of OVld_i_1 : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \RP[1]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \RP[2]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \RP[3]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \RP[4]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \RP[6]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \RP[7]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \WP[1]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \WP[2]_i_1\ : label is "soft_lutpair12";
  ...
  attribute SOFT_HLUTNM of \WP[7]_i_2\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \blkRep.RepCnt[0]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \blkRep.RepCnt[1]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \blkRep.RepCnt[2]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \blkRep.RepCnt[3]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \blkRep.RepCnt[4]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \blkRep.RepCnt[6]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \blkRep.RepCnt[6]_i_2\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \blkRep.RepLst_i_3\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of in0_V_TREADY_INST_0_i_2 : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of in0_V_TREADY_INST_0_i_6 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of weights_V_TREADY_INST_0 : label is "soft_lutpair10";
begin
...
\FP[7]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
Last_i_4: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\ODat[0]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\ODat[1]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\ODat[2]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\ODat[3]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\ODat[4]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\ODat[5]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\ODat[6]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\ODat[7]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\RP[7]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"8000000000000000"
    )
        port map (
...
\WP[7]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"2828282882288282"
    )
        port map (
      I0 => in0_V_TVALID,
      I1 => \WP_reg_n_0_[7]\,
...
\WP[7]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"6A"
    )
        port map (
...
\WP[7]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"8000000000000000"
    )
        port map (
...
\blkRep.RepCnt[5]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => \blkRep.RepCnt_reg\(4),
      I3 => \blkRep.RepCnt_reg\(2),
      I4 => \blkRep.RepCnt_reg\(1),
      I5 => \blkRep.RepCnt_reg_n_0_[0]\,
      O => \p_0_in__1\(5)
    );
\blkRep.RepCnt[6]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"9AAAAAAA"
    )
        port map (
      I0 => \blkRep.RepCnt_reg\(6),
      I1 => \blkRep.RepCnt[6]_i_2_n_0\,
      I2 => \blkRep.RepCnt_reg\(4),
      I3 => \blkRep.RepCnt_reg\(3),
      I4 => \blkRep.RepCnt_reg\(5),
      O => \p_0_in__1\(6)
    );
\blkRep.RepCnt[6]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
\blkRep.RepLst_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => \blkRep.RepLst_i_3_n_0\,
      I4 => \blkRep.RepCnt_reg\(1),
      I5 => \blkRep.RepCnt_reg\(2),
      O => \blkRep.RepLst0\
    );
\blkRep.RepLst_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
      I0 => \blkRep.RepCnt_reg\(3),
      I1 => \blkRep.RepCnt_reg\(4),
      O => \blkRep.RepLst_i_3_n_0\
    );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity finn_design_MVAU_rtl_8_0_mvu_vvu_axi is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of finn_design_MVAU_rtl_8_0_mvu_vvu_axi : entity is "mvu_vvu_axi";
end finn_design_MVAU_rtl_8_0_mvu_vvu_axi;

architecture STRUCTURE of finn_design_MVAU_rtl_8_0_mvu_vvu_axi is
...
activation_replay: entity work.finn_design_MVAU_rtl_8_0_replay_buffer
     port map (
...
\blkDsp.genblk2_2.core\: entity work.finn_design_MVAU_rtl_8_0_mvu_8sx8u_dsp48
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity finn_design_MVAU_rtl_8_0_MVAU_rtl_8 is
  port (
    out_V_TDATA : out STD_LOGIC_VECTOR ( 20 downto 0 );
    in0_V_TREADY : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of finn_design_MVAU_rtl_8_0_MVAU_rtl_8 : entity is "MVAU_rtl_8";
end finn_design_MVAU_rtl_8_0_MVAU_rtl_8;

architecture STRUCTURE of finn_design_MVAU_rtl_8_0_MVAU_rtl_8 is
begin
inst: entity work.finn_design_MVAU_rtl_8_0_mvu_vvu_axi
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity finn_design_MVAU_rtl_8_0 is
  port (
    ap_clk : in STD_LOGIC;
    ap_rst_n : in STD_LOGIC;
    weights_V_TDATA : in STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  attribute NotValidForBitStream of finn_design_MVAU_rtl_8_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of finn_design_MVAU_rtl_8_0 : entity is "finn_design_MVAU_rtl_8_0,MVAU_rtl_8,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of finn_design_MVAU_rtl_8_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of finn_design_MVAU_rtl_8_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of finn_design_MVAU_rtl_8_0 : entity is "MVAU_rtl_8,Vivado 2024.1";
end finn_design_MVAU_rtl_8_0;

architecture STRUCTURE of finn_design_MVAU_rtl_8_0 is
...
begin
  ...
  out_V_TDATA(20 downto 0) <= \^out_v_tdata\(20 downto 0);
inst: entity work.finn_design_MVAU_rtl_8_0_MVAU_rtl_8
     port map (
